...
describe('sqlHelper', () => {
  ...
  beforeAll(() => {
    ...
    const modelDefs: { name: string; tableDef: TableDefinition<any, any> }[] = [
      { name: 'Category', tableDef: Category },
      { name: 'ImportedItem', tableDef: ImportedItem },
      { name: 'KitchenSink', tableDef: KitchenSink },
      { name: 'Product', tableDef: Product },
      { name: 'ProductCategory', tableDef: ProductCategory },
      { name: 'ProductWithCreatedAt', tableDef: ProductWithCreatedAt },
      { name: 'ProductWithCreateUpdateDateTracking', tableDef: ProductWithCreateUpdateDateTracking },
      { name: 'ReadonlyProduct', tableDef: ReadonlyProduct },
      { name: 'RequiredPropertyWithDefaultValue', tableDef: RequiredPropertyWithDefaultValue },
      { name: 'RequiredPropertyWithDefaultValueFunction', tableDef: RequiredPropertyWithDefaultValueFunction },
      { name: 'SimpleWithCollections', tableDef: SimpleWithCollections },
      { name: 'SimpleWithCreatedAt', tableDef: SimpleWithCreatedAt },
      { name: 'SimpleWithCreatedAtAndUpdatedAt', tableDef: SimpleWithCreatedAtAndUpdatedAt },
      { name: 'SimpleWithJson', tableDef: SimpleWithJson },
      { name: 'SimpleWithSchema', tableDef: SimpleWithSchema },
      { name: 'SimpleWithStringId', tableDef: SimpleWithStringId },
      { name: 'SimpleWithUpdatedAt', tableDef: SimpleWithUpdatedAt },
      { name: 'SimpleWithUUID', tableDef: SimpleWithUUID },
      { name: 'SimpleWithVersion', tableDef: SimpleWithVersion },
      { name: 'Store', tableDef: Store },
    ];
